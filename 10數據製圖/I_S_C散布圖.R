...
label_controls <- list(
  "IBXM" = list(
    "100" = list(n_x = 0, n_y = 0.1, h_adj = 0.5),
    "101" = list(n_x = 0, n_y = 0.1, h_adj = 0.5),
    "102" = list(n_x = 0.1, n_y = 0.1, h_adj = 0.5),
    "103" = list(n_x = 0, n_y = -0.1, h_adj = 0.5),
    "104" = list(n_x = 0, n_y = 0.1, h_adj = 0.5),
    "105" = list(n_x = 0, n_y = 0.1, h_adj = 0.5)
  ),
  "SBXM" = list(
    "100" = list(n_x = -0.3, n_y = 0.1, h_adj = 0.5),
    "101" = list(n_x = -0.25, n_y = 0, h_adj = 0.5), 
    "102" = list(n_x = 0, n_y = 0.1, h_adj = 0.5),
    "103" = list(n_x = 0, n_y = 0.1, h_adj = 0.5),
    "104" = list(n_x = 0, n_y = 0.1, h_adj = 0.5),
    "105" = list(n_x = 0, n_y = 0.1, h_adj = 0.5)
  ),
  "CBXM" = list(
    "100" = list(n_x =  0, n_y = -0.1, h_adj = 0.5), 
    "101" = list(n_x =  0, n_y = -0.2, h_adj = 0.5),
    "102" = list(n_x =  -0.1,    n_y =  0.1, h_adj = 0.5),
    "103" = list(n_x =  0.25,    n_y =  0, h_adj = 0.5),
    "104" = list(n_x =  0,    n_y = -0.1, h_adj = 0.5),
    "105" = list(n_x =  0.3,    n_y = 0, h_adj = 0.5)
  )
)
# =========================================================
...
p <- ggplot() +
  ...
  coord_cartesian(xlim = c(11, 18), ylim = c(6, 10)) + 
...
# 5. 輸出
export_path <- file.path(base_path, "pictures", "Risk_Return_Scatter_Plot_I_S_C.png")
